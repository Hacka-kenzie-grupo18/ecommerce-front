  ...
  return (
    ...
    >
      ...
      <fieldset className="relative flex flex-col gap-2 border-none">
        <label className="font-500 text-[14px] text-[#2563eb]">Nome</label>
        <input
        ...
        />
        <span
          className={`error-message text-[15px] ${
        ...
        <label className="font-500 text-[14px] text-[#2563eb]">CPF</label>
        <input
          className="h-12 w-full outline-none bg-whiteFixed text-grey1 rounded-4 border-2 border-grey4 hover:bg-grey9 focus-border-[#2563eb] px-4 font-semibold"
          {...register("cpf")}
        ...
        <span
          className={`error-message text-[15px] ${
            errors.cpf?.message ? "block" : "hidden"
          }`}
        >
          {errors.cpf?.message}
        </span>
      ...
      <div className="flex gap-3">
        ...
        <fieldset className="relative flex flex-col gap-2 border-none">
          <label className="font-500 text-[14px] text-[#2563eb]">CEP</label>
          <input
            className="h-12 w-full outline-none bg-whiteFixed text-grey1 rounded-4 border-2 border-grey4 hover:bg-grey9 focus-border-[#2563eb] px-4 font-semibold"
          ...
          <span
            className={`error-message text-[15px] ${
              errors.cep?.message ? "block" : "hidden"
            }`}
          >
            {errors.cep?.message}
          </span>
      ...
      <fieldset className="relative flex flex-col gap-2 border-none">
        <label className="font-500 text-[14px] text-[#2563eb]">Endereço</label>
        <input
          className="h-12 w-full outline-none bg-whiteFixed text-grey1 rounded-4 border-2 border-grey4 hover:bg-grey9 focus-border-[#2563eb] px-4 font-semibold"
        ...
        <span
          className={`error-message text-[15px] ${
            errors.street?.message ? "block" : "hidden"
          }`}
        >
      ...
      <div className="flex gap-3">
        <fieldset className="relative flex flex-col gap-2 border-none">
          <label className="font-500 text-[14px] text-[#2563eb]">Estado</label>
          <input
            className="h-12 w-full outline-none bg-whiteFixed text-grey1 rounded-4 border-2 border-grey4 hover:bg-grey9 focus-border-[#2563eb] px-4 font-semibold"
            {...register("state")}
            placeholder="Automaticamente preenchido"
        ...
        <fieldset className="relative flex flex-col gap-2 border-none">
          <label className="font-500 text-[14px] text-[#2563eb]">Número</label>
          <input
            className="h-12 w-full outline-none bg-whiteFixed text-grey1 rounded-4 border-2 border-grey4 hover:bg-grey9 focus-border-[#2563eb] px-4 font-semibold"
            {...register("number")}
          ...
          <span
            className={`error-message text-[15px] ${
              errors.number?.message ? "block" : "hidden"
            }`}
          >
      ...
      <fieldset className="relative flex flex-col gap-2 border-none">
        <label className="font-500 text-[14px] text-[#2563eb]">Cidade</label>
        <input
          className="h-12 w-full outline-none bg-whiteFixed text-grey1 rounded-4 border-2 border-grey4 hover:bg-grey9 focus-border-[#2563eb] px-4 font-semibold"
          placeholder="Automaticamente preenchido"
          {...register("city")}
        ...
        <span
          className={`error-message text-[15px] ${
            errors.city?.message ? "block" : "hidden"
          }`}
        >
          {errors.city?.message}
        </span>
